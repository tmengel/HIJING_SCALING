...
void Fun4All_UEScaling_Pass1 ( 
    ...
    const int segment               = 0,
    const std::string & outfile     = "CALO_TREE_noNoise_waveformFit_sHijing_0_20fm-00000031-00000.root"
)
{
    ...
    ctb_hcalout -> set_softwarezerosuppression( true, 60 );
    ...
    ctb_hcalin -> set_softwarezerosuppression( true, 30 );
    ...
    ctb_cemc -> set_softwarezerosuppression( true, 30 );
